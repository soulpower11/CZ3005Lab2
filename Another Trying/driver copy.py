        ...
        for Y in range(len(board[X])):
            ...
            if f'{X},{Y}' in visited_map:
                for innerX in range(len(cell)):
                    for innerY in range(len(cell[innerX])):
                        if innerX == 2 and X != len(board)-1:
                            line[Y][innerY] += f"\033[1;34;48m {cell[innerX][innerY]}  \033[0m"
                        else:
                            line[Y][innerY] += f"\033[1;34;48m {cell[innerX][innerY]}\033[0m"
            elif f'{X},{Y}' in rwalls_map:
                for innerX in range(len(cell)):
                    for innerY in range(len(cell[innerX])):
                        if innerX == 2 and X != len(board)-1:
                            line[Y][innerY] += f"\033[1;31;48m {cell[innerX][innerY]}  \033[0m"
                        else:
                            line[Y][innerY] += f"\033[1;31;48m {cell[innerX][innerY]}\033[0m"
            ...
            #                 line[Y][innerY] += f" {cell[innerX][innerY]}"
                ...
                for innerX in range(len(cell)):
                    for innerY in range(len(cell[innerX])):
                        if innerX == 2 and X != len(board)-1:
                            line[Y][innerY] += f"\033[1;30;48m {cell[innerX][innerY]}  \033[0m"
                        else:
                            line[Y][innerY] += f"\033[1;30;48m {cell[innerX][innerY]}\033[0m"
                ...
                for innerX in range(len(cell)):
                    for innerY in range(len(cell[innerX])):
                        if innerX == 2 and X != len(board)-1:
                            line[Y][innerY] += f"\033[1;32;48m {cell[innerX][innerY]}  \033[0m"
                        else:
                            line[Y][innerY] += f"\033[1;32;48m {cell[innerX][innerY]}\033[0m"
