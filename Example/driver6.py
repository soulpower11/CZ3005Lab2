    ...
    def shoot(self, world):
        ...
        while hit == False:
            ...
            if world.world[world.agentY+ym[direction]+y][world.agentX+xm[direction]+x].wumpus:
                ...
                world.world[world.agentY+ym[direction]+y][world.agentX+xm[direction]+x].wumpus = False
                wumpusY = world.agentY+ym[direction]+y
                wumpusX = world.agentX+xm[direction]+x
                for i in range(4):
                    world.world[wumpusY+ym[i]][wumpusX+xm[i]].stench = False
                self.percepts(world.world[world.agentY][world.agentX], 'scream')
...
while not quitgame:
    ...
    if option == '1':
        ...
        action_sequence = ['turnleft', 'moveforward', 'turnright', 'moveforward', 'moveforward','moveforward','moveforward','turnright','moveforward','moveforward','turnright','turnright','moveforward','turnleft','moveforward','moveforward','moveforward','moveforward','moveforward','turnleft','turnleft','moveforward','turnright','moveforward','moveforward','moveforward','moveforward','turnright','moveforward','turnright','turnright','moveforward','moveforward','moveforward','moveforward']
        ...
        for movement in action_sequence:
            ...
            if agent.alive == False:
                    print_slow('you died!')
                    print_slow('respawning...:' +str(bool(list(prolog.query("reborn")))))
                    agent.resetAgent()
                    world.resetWorld()
    ...
    if option == '2':
        ...
        action_sequence = ['turnright', 'moveforward','turnleft','moveforward','moveforward','turnright','turnright','moveforward','turnleft','moveforward','moveforward','moveforward','moveforward','moveforward','turnleft','moveforward','turnleft','moveforward']
    ...
    if option == '3':
        ...
        action_sequence = ['turnleft', 'moveforward', 'turnright', 'moveforward', 'moveforward','moveforward','moveforward','turnright','moveforward','moveforward','turnright','moveforward']
    ...
    if option == '5':
        ...
        action_sequence = ['turnleft', 'moveforward', 'turnright', 'moveforward', 'moveforward','moveforward','moveforward','turnright','moveforward','turnright','moveforward','moveforward','turnleft','moveforward','moveforward','turnright','moveforward']
